Feature: User Management
  ...
  Scenario: Duplicate Accounts
    Given the owner is logged into the system with email "mashaqi@gmail.com" and password "pass"
  ...
  Scenario: Update user information
    Given  admin have logged into the system with email "mashaqi@gmail.com" and password "pass"
    And the user exist
  ...
  Scenario: Update a User’s role Successfully
    Given   logged into the system with email "mashaqi@gmail.com" and password "pass"
  ...
  Scenario: Restore a Deactivated User
    Given the admin is logged to the system with email "mashaqi@gmail.com" and password "pass"
  ...
  Scenario: Deactivate a User Successfully
    Given the admin logged into the system with email "mashaqi@gmail.com" and password "pass"
  ...
  Scenario: Prevent Deactivation of Admin Accounts
    Given the admin is logged into the system email "mashaqi@gmail.com" and password "pass"
  ...
  Scenario: View Most Engaged Users
    Given the admin has logged into the system with email "mashaqi@gmail.com" and password "pass"
  ...
  Scenario: Identify Users with No Engagement
    Given the admin is log into the system with email "mashaqi@gmail.com" and password "pass"
  ...
  Scenario: Download Engagement Report
    Given the admin has logg into the system with email "mashaqi@gmail.com" and password "pass"
  ...
  Scenario: Search for Users by name
    Given the admin is in the system via email "mashaqi@gmail.com" and password "pass"
