Feature: Client Interaction
  ...
  Background:
    ...
    And Malik has logged to the system
 ...
 #first part
    ...
    Scenario: Ahmad post a question in the discussion form
        Given Ahmad logged to the system
        When Ahmad post a question message "What is the best food for more power?" in the discussion form
    ...
    Scenario: Malik answer the clients questions on the discussion form
          Given Ahmad asks a question "What is the most power?" in the discussion form
    ...
    Scenario: Other clients answer Ahmad's question
            ...
            And Ahmad post a question message "What is the best food for more power?" in the discussion form
    ...
    Scenario: there's a previous answer for a new question
              Given Ahmad post a question message "What is the best food for more power?" in the discussion form
