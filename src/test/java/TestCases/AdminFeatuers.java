...
public class AdminFeatuers {
    ...
    public void displays_the_message(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Given("the admin is logged the system with email {string} and password {string}")
    public void the_admin_is_logged_the_system_with_email_and_password(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @When("provides a valid user id")
    public void provides_a_valid_user_id() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void the_admin_executes_the_update_user_details() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Given("the user exists with a valid ID")
    public void the_user_exists_with_a_valid_id() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("the admin executes the updateUserRole command with the user ID and role {string}")
    public void the_admin_executes_the_update_user_role_command_with_the_user_id_and_role(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Given("the admin is logged into system with email {string} and password {string}")
    public void the_admin_is_logged_into_system_with_email_and_password(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("the admin executes the deactivateUser with the user ID")
    public void the_admin_executes_the_deactivate_user_with_the_user_id() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("The system displays the message: {string}")
    public void the_system_displays_the_message(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Given("the admin is logged in the system with email {string} and password {string}")
    public void the_admin_is_logged_in_the_system_with_email_and_password(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void the_admin_executes_the_approve_registration_command_with_the_instructor_s_id() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("the system activates the instructor account")
    public void the_system_activates_the_instructor_account() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Given("the admin is logg into the system with email {string} and password {string}")
    public void the_admin_is_logg_into_the_system_with_email_and_password(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("the admin executes the rejectRegistration command with the instructor’s ID and a reason")
    public void the_admin_executes_the_reject_registration_command_with_the_instructor_s_id_and_a_reason() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("the system marks the registration as rejected")
    public void the_system_marks_the_registration_as_rejected() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void the_admin_is_in_the_system_via_email_and_password(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Given("the following users exist in the system:")
    public void the_following_users_exist_in_the_system(io.cucumber.datatable.DataTable dataTable) {
        // Write code here that turns the phrase above into concrete actions
    ...
    public void the_admin_executes_the_search_user_command_with_the_parameter(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("the system displays the following matching users:")
    public void the_system_displays_the_following_matching_users(io.cucumber.datatable.DataTable dataTable) {
        // Write code here that turns the phrase above into concrete actions
        // For automatic transformation, change DataTable to one of
        // E, List<E>, List<List<E>>, List<Map<K,V>>, Map<K,V> or
        // Map<K, List<V>>. E,K,V must be a String, Integer, Float,
    ...
    public void the_system_displays_message(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Given("admin has log into the system via email {string} and password {string}")
    public void admin_has_log_into_the_system_via_email_and_password(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("the admin executes the searchUser command with the parameter Role")
    public void the_admin_executes_the_search_user_command_with_the_parameter_role() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("the system displays {int} John Doe Client Active")
    public void the_system_displays_john_doe_client_active(Integer int1) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("the system displays {int} Johnny Appleseed Client Inactive")
    public void the_system_displays_johnny_appleseed_client_inactive(Integer int1) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("the system displays {int} Joan Harris Client Active")
    public void the_system_displays_joan_harris_client_active(Integer int1) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Given("admin has log into the system with email {string} and password {string}")
    public void admin_has_log_into_the_system_with_email_and_password(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("the admin executes the searchUser command with the parameter Status>")
    public void the_admin_executes_the_search_user_command_with_the_parameter_status() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("the system displays {int} Jane Smith Instructor Active")
    public void the_system_displays_jane_smith_instructor_active(Integer int1) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
