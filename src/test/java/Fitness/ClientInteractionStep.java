...
public class ClientInteractionStep
{
    ...
    public void client_named_has_enrolled_in_a_malik_s_program(String string) {
    ...
    public void malik_sends_a_message_to_ahmad(String string) {
    ...
    public void ahmad_send_a_message_to_malik_hey_instructor_malik_when_should_start_training() {
    ...
    @When("Ahmad post a question message {string} in the discussion form")
    public void ahmad_post_a_question_message_in_the_discussion_form(String string) {
    ...
    @Given("Ahmad asks a question {string} in the discussion form")
    public void ahmad_asks_a_question_in_the_discussion_form(String string) {
    ...
    @Given("Emad has logged to the system")
    ...
    public void sami_answer_ahmad(String string) {
