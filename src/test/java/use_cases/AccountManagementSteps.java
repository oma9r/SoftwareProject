...
String b;
    ...
    public void the_user_fills_out_the_form_with_valid_information(io.cucumber.datatable.DataTable dataTable) {
        ...
        currentUser.setFitnessGoals(fitnessGoals);
        currentUser.setDietaryPreference(dietaryPreferences);
        currentUser.setDietaryRestriction(dietaryRestrictions);
    ...
    public void the_system_saves_the_profile_information() {
        ...
        assertTrue("Optional field (e.g., Dietary Preferences) should be empty or null",
                currentUser.getDietaryPreference() == null || currentUser.getDietaryPreference().isEmpty());
        assertTrue("Optional field (e.g., Dietary Restrictions) should be empty or null",
                currentUser.getDietaryRestriction() == null || currentUser.getDietaryRestriction().isEmpty());
    ...
    public void the_user_modifies_any_field_e_g_updates_dietary_preferences() {
        ...
        currentUser.setDietaryPreference(newDietaryPreference);
        assertEquals("Dietary preference update failed.", newDietaryPreference, currentUser.getDietaryPreference());
    ...
    public void the_user_fills_out_only_the_mandatory_fields(DataTable dataTable) {
        ...
        assertEquals(fitnessGoals, currentUser.getFitnessGoals());
